...
- [ ] **AUTH-09**: Endpoint LGPD account-deletion: aluno solicita → email confirma → `fn_delete_user_cascade` Postgres function deleta dados + chama Supabase `auth.admin.deleteUser()` + dispara webhook para deletar de Resend/PostHog/Sentry
